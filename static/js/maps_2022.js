...
let theftsLayerGroup_2022 = new L.LayerGroup();
let homicideLayerGroup_2022 = new L.LayerGroup();
let arsonLayerGroup_2022 = new L.LayerGroup();
let aggAssaultLayerGroup_2022 = new L.LayerGroup();
let sexOffenseLayerGroup_2022 = new L.LayerGroup();
let liquorLayerGroup_2022 = new L.LayerGroup();
let fraudLayerGroup_2022 = new L.LayerGroup();
let drugLayerGroup_2022 = new L.LayerGroup();
let familyOffenseLayerGroup_2022 = new L.LayerGroup();
let otherOffenseLayerGroup_2022 = new L.LayerGroup();

// Create panes
map.createPane('crime2022');
map.getPane('crime2022').style.zIndex = 650;

let District_GeoJSON_Path = "../static/json/Philadelphia-Neighborhood_FoodRetail.geojson";
let Philadelphia_Crime_2022_Path = "../static/json/Philadelphia_Crime_Data-2022_Short.geojson";
...
let overlays = {
    ...
    "Thefts - 2022" : theftsLayerGroup_2022,
    "Homicide - 2022" : homicideLayerGroup_2022,
    "Arson - 2022" : arsonLayerGroup_2022,
    "Aggravated Assault - 2022" : aggAssaultLayerGroup_2022,
    "Sex Offenses - 2022" : sexOffenseLayerGroup_2022,
    "Liquor Violations - 2022" : liquorLayerGroup_2022,
    "Fraud & Embezzlement - 2022" : fraudLayerGroup_2022,
    "Drug Violations - 2022" : drugLayerGroup_2022,
    "Family & Children Offenses - 2022" : familyOffenseLayerGroup_2022,
    "Other Crimes - 2022": otherOffenseLayerGroup_2022
};
...
// Filter All Theft Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    theft.addTo(theftsLayerGroup_2022);
});
theftsLayerGroup_2022.addTo(map);

// Filter All Homicide Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    homicide.addTo(homicideLayerGroup_2022);
});
homicideLayerGroup_2022.addTo(map);

// Filter All Arson Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    arson.addTo(arsonLayerGroup_2022);
});
arsonLayerGroup_2022.addTo(map);

// Filter All Aggravated Assault Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    aggAssault.addTo(aggAssaultLayerGroup_2022);
});
aggAssaultLayerGroup_2022.addTo(map);

// Filter All Sexual Assault Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    sexOffenses.addTo(sexOffenseLayerGroup_2022);
});
sexOffenseLayerGroup_2022.addTo(map);

// Filter All Liquor Violations Crime in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    liquorAssault.addTo(liquorLayerGroup_2022);
});
liquorLayerGroup_2022.addTo(map);

// Filter All Fraud Embezzlement Crimes in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    fraudCrimes.addTo(fraudLayerGroup_2022);
});
fraudLayerGroup_2022.addTo(map);
...
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    liquorViolation.addTo(liquorLayerGroup_2022);
});
liquorLayerGroup_2022.addTo(map);

// Filter All Drug Crimes in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    drugViolation.addTo(drugLayerGroup_2022);
});
drugLayerGroup_2022.addTo(map);

// Filter All Family Crimes in 2022
d3.json(Philadelphia_Crime_2022_Path).then(function(data) {
    ...
    familyCrimes.addTo(familyOffenseLayerGroup_2022);
});
familyOffenseLayerGroup_2022.addTo(map);
